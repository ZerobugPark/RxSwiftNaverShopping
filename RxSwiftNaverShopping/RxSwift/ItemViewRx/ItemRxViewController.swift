...
final class ItemRxViewController: UIViewController {
...
//                value.itemView.collectionView.rx.items(cellIdentifier: ItemRxCollectionViewCell.id, cellType: ItemRxCollectionViewCell.self) {
//                    
//                }
//                
//            }
...
//
    ...
    deinit {
        ...
        print("ItemRxViewController Deinit")
    }
